...
export class EditorToolbarComponent {
  ...
  activeTool = input.required<EditorTool>();
  ...
  readonly tools: ToolbarButton[] = [
    { tool: 'select', icon: 'pi pi-arrow-up-right', label: 'تحديد', tooltip: 'أداة التحديد والتحريك' },
    ...
    { tool: 'text', icon: 'pi pi-language', label: 'نص', tooltip: 'إضافة نص' },
  ];
