...
export interface ICurriulumPublicClient {
     ...
     * @return OK
     */
    getAllByDeptIdAndYearId(departmentId: number, yearId?: number | undefined): Observable<ResultOfListOfGetCurriculumDto>;
    /**
     * @return OK
     */
...
export class CurriulumPublicClient implements ICurriulumPublicClient {
     ...
     * @return OK
     */
    getAllByDeptIdAndYearId(departmentId: number, yearId?: number | undefined, httpContext?: HttpContext): Observable<ResultOfListOfGetCurriculumDto> {
        ...
        if (yearId === null)
            throw new globalThis.Error("The parameter 'yearId' cannot be null.");
...
export interface ITestClient {
     ...
     * @return OK
     */
    start(body: StartTestCommand): Observable<ResultOfTestDataDto>;
    /**
     * @return OK
     */
    submit(body: SubmitTestCommand): Observable<ResultOfTestResultDto>;
}
...
export class TestClient implements ITestClient {
     ...
     * @return OK
     */
    start(body: StartTestCommand, httpContext?: HttpContext): Observable<ResultOfTestDataDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ResultOfTestDataDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ResultOfTestDataDto>;
        }));
    }

    protected processStart(response: HttpResponseBase): Observable<ResultOfTestDataDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : jsonParse(_responseText, this.jsonParseReviver) as ResultOfTestDataDto;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    submit(body: SubmitTestCommand, httpContext?: HttpContext): Observable<ResultOfTestResultDto> {
        let url_ = this.baseUrl + "/api/Test/submit";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ResultOfTestResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ResultOfTestResultDto>;
        }));
    }

    protected processSubmit(response: HttpResponseBase): Observable<ResultOfTestResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : jsonParse(_responseText, this.jsonParseReviver) as ResultOfTestResultDto;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export interface OptionTestDto {
    id?: number;
    content?: string;
    isSelected?: boolean;
...
export interface ResultOfTestDataDto {
    data?: TestDataDto | null;
    isSuccess?: boolean;
    statusCode?: number;
    errors?: ValidationError[];
    message?: string | null;
...
export interface ResultOfTestResultDto {
    data?: TestResultDto | null;
    isSuccess?: boolean;
    statusCode?: number;
    errors?: ValidationError[];
    message?: string | null;
